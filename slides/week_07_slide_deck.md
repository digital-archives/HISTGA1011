...
![Workflow diagram to determine whether you may digitize a thing.](img/week_07_copyright_flow.png)
...
| **Resolution** | - **Manuscripts, Text, Maps**: 300-400 PPI<br>- **Photographs/Graphics**: 400-600 PPI<br>- **Film/Negatives/Slides**: 3,000-4,000 PPI  |
| **Bit/Color Depth** | - **Bitonal (Black & White)**: 1-bit<br>- **Grayscale**: 8-bit minimum<br>- **Color**: 24-bit |
