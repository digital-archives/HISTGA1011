...
2. **Document your findings in Airtable**  
   Open and complete the <a href="https://airtable.com/app7qqjN2nnglfPfD/pag5PKEZC1XAvye3O/form" target="_blank">Data Object Airtable Form</a>. This will generate a visual "card" in the shared <a href="https://airtable.com/app7qqjN2nnglfPfD/shrG93LaV2ZbOWPKE" target="_blank">Airtable gallery</a> (please note, this will be visible to both me, and the rest of the class on the day we present). Use this card to summarize key details about your chosen data object.
